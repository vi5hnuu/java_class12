...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("are you eligible");

        jLabel3.setText("enter no.");

        jLabel4.setText("is the no. positive or negative");
...
if(a>=18)
tf2.setText("eligible");
else
tf2.setText("not eligible");
int b=Integer.parseInt(tf3.getText());
if(b>=0)
tf4.setText("positive");
else
tf4.setText("negative");// TODO add your handling code here:
